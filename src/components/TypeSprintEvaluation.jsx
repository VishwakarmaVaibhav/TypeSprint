...
const TypingEvaluation = () => {
   ...
   <header className="bg-blue-600 text-white p-4 text-lg font-bold flex justify-between items-center relative">
                <span>Typing Speed Evaluation</span>
                ...
                <nav className={`absolute md:relative top-12 right-0 bg-blue-600 p-4 md:p-0 md:flex md:static ${menuOpen ? 'block' : 'hidden'}`}>
                    <Button className="mx-2">Round 1</Button>
                    <Button className="mx-2">Round 2</Button>
                    <Button className="mx-2">Final</Button>
                </nav>
            </header>
        ...
        <div className="  bg-gray-100 min-h-screen">
            ...
            <h1 className="text-3xl font-extrabold pt-6 text-center mb-6 animate-fade-in">Typing Speed Evaluation</h1>
